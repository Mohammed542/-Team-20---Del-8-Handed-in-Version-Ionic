(self["webpackChunkaasifionic"] = self["webpackChunkaasifionic"] || []).push([["common"],{
...
/***/ 2390:
/*!*****************************************!*\
  !*** ./src/app/pages/access.service.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let AccessService = class AccessService {
    constructor(http) {
        this.http = http;
        this.url = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiURL + '/Access/';
    }
